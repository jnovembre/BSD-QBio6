...
While comments are useful and necessary, you should always strive to write code that is understandable by itself. Let's look at an example. You can follow along with our changes by cloning the repository at [https://github.com/grahamas/CuteNameHere](https://github.com/grahamas/CuteNameHere) The below code shouldn't really need any comments to be understandable, but see if you can understand its purpose, as-is:
...
This code technically "works." It will run, and it will print a result. But what does the result mean? No idea! Here are some good coding principles that it violates, that make it much harder to understand:
