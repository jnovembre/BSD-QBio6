...
While comments are useful and necessary, you should always strive to write code that is understandable by itself. Let's look at an example. You can see a this example drawn out to its extremely painful conclusion in the repository at [https://github.com/grahamas/CuteNameHere](https://github.com/grahamas/CuteNameHere). The below code is *technically* fairly simple, and shouldn't really need any comments to be understandable. But *practically* it's another story. See if you can tease out its purpose, as-is:
